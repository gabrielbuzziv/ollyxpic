...
class TeamHuntController extends Controller
{
    ...
    private function prepareName($name)
    {
        ...
        $names = [
            ...
            "broken visors"                            => "broken visor",
            "sights of surrender's eye"                => "sight of surrender's eye",
            "pieces of hellfire armor"                 => "piece of hellfire armor",
            "terramite leg"                            => "terramite legs",
            "terramite egg"                            => "terramite eggs",
            "diremaw brainpans"                        => "diremaw brainpan",
            "lost husher's staffs"                     => "Lost Husher's Staff",
            "holy ashes"                               => "holy ash",
            "bonecarving knives"                       => "bonecarving knife",
            "bone fetishes"                            => "bone fetish",
            "wimp teeth chain"                         => "wimp tooth chain",
            "yielock"                                  => "yielocks",
            "boggy dread"                              => "boggy dreads",
            "carniphila seed"                          => "carniphila seeds",
            "widow's mandible"                         => "widow's mandibles",
            "books of necromantic rituals"             => "book of necromantic rituals",
            "pieces of crocodile leather"              => "piece of crocodile leather",
            "midnight shards"                          => "midnight shard",
            "quara pincer"                             => "quara pincers",
            "compa"                                    => "compass",
            "skulls"                                   => "skull",
            "sudden death runes"                       => "sudden death runes",
