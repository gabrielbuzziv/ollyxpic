...
class TeamHuntController extends Controller
{
    ...
    private function prepareName($name)
    {
        ...
        $names = [
            ...
            "book of necromantic rituals"    => "book of necromantic ritual",
            ...
            "scroll of heroic deeds"         => "scroll of heroic deed",
            ...
            "crystalline spikes"             => "crystalline spike",
            ...
            "incantation notes"              => "incantation note",
            ...
            "wereboar tusks"                 => "wereboar tusk",
            "wereboar hooves"                => "wereboar hoove",
            "werewolf fangs"                 => "werewolf fang",
            "werebadger skulls"              => "werebadger skull",
            "werebear skulls"                => "werebear skull",
            "werebear furs"                  => "werebear fur",
            "werebadger claws"               => "werebadger claw",
            "ogre ear studs"                 => "ogre ear stud",
            "ogre nose rings"                => "ogre nose ring",
            "pair of hellflayer horns"       => "pair of hellflayer horn",
            "shamanic talismans"             => "shamanic talisman",
            "some grimeleech wings"          => "some grimeleech wing",
            ...
            "sparkion legs"                  => "sparkion leg",
            "curious matters"                => "curious matter",
            "plasma pearls"                  => "plasma pearl",
            ...
            "sparkion stings"                => "sparkion sting",
