<template>
    <page-load id="hardcore">
        ...
        <panel class="result" v-if="isValid">
            ...
            <ul>
                <li>First frag: {{ experience | reduce '0' }}</li>
                <!-- <li>Second frag: {{ experience | reduce(0.1) }}</li>
                <li>Third frag: {{ experience | reduce(0.2) }}</li>
                <li>Fourth frag: {{ experience | reduce(0.3) }}</li>
                <li>Fifth frag: {{ experience | reduce(0.4) }}</li> -->
            </ul>
        </panel>
...
export default {
    ...
    filters: {
        ...
        reduce(data, amount) {
            console.log(amount)
            return data ? data * (1 - reduce) : data
        }
    },
